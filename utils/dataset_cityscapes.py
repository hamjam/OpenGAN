...
class Cityscapes(Dataset):
    ...
    def __init__(self, root='/home/skong2/restore/dataset/Cityscapes',
                 newsize=(256, 256),
                 split='train',
                 mode='fine',
                 target_type='semantic',
    ...
    def __getitem__(self, index):
        ...
        if self.flagResize:
            image = image.resize(self.newsize, resample=Image.BILINEAR)
        #print(self.targets[index], self.target_type)
        ...
        for i, t in enumerate(self.target_type):
            if t == 'polygon':
                ...
                if self.flagResize:
                    target = target.resize(self.newsize, resample=Image.NEAREST)
